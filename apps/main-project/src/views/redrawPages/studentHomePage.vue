...
const mockStudentProfileData = {
  "👤 学生画像摘要": "刘镇武同学学习参与度较高，但知识掌握程度存在明显分化，属于‘积极投入但理解不均衡’的类型。最突出的优势是学习态度认真，参与积极；最需关注的风险是部分核心知识点掌握薄弱，且整体学习投入度有下滑趋势，可能影响后续学习效果。",
  "📚 知识点掌握分析": {
    "优势领域（掌握率 ≥80%）": [
      "集合与逻辑（掌握率：92%）",
      "函数定义域（掌握率：88%）"
  ...
  "🎯 个性化优化建议": {
    ...
    "给教师/助教的建议": [
      "关注其学习状态：可与刘镇武同学进行一次简短交流，了解其近期学习感受，对下降趋势给予关心和鼓励，帮助其重拾学习节奏。",
